  ...
  <div>
    <b-row class="m-0 d-none d-lg-flex">
      <b-col cols="12" lg="4" class="mb-3" >
        <div class="mb-3" v-for="(item, a) in data.filter(x => x.id == 1 || x.id == 4 || x.id == 7)" :key="'kw-d-'+item.id">
          <b-button
      ...
      <b-col cols="12" lg="4" class="mb-3" >
        <div class="mb-3" v-for="(item, a) in data.filter(x => x.id == 2 || x.id == 5)" :key="'kw-d-'+item.id">
          <b-button
            v-b-toggle="'collapse-set-d-' + item.id"
            variant="primary"
            class="keyword-collapse w-100 bg-blue-a text-1 p-0"
      ...
      <b-col cols="12" lg="4" class="mb-3" >
        <div class="mb-3" v-for="(item, a) in data.filter(x => x.id == 3 || x.id == 6)" :key="'kw-d-'+item.id">
          <b-button
            v-b-toggle="'collapse-set-d-' + item.id"
            variant="primary"
            class="keyword-collapse w-100 bg-blue-a text-1 p-0"
    ...
    <b-row class="m-0 d-flex d-lg-none">
      <b-col cols="12" lg="4" class="mb-3" v-for="(item, i) in data" :key="'kw-'+item.id">
        <div class="mb-3" >
          <b-button
